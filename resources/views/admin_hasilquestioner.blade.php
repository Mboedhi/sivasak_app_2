...
<header>
    ...
    <div class="sidebar">
        <ul>
            ...
            <li><img src="{{ asset('cb.png') }}" alt=""><a href="/admin_vendorselection">Seleksi Vendor</a>
            </li>
            <li><img src="{{ asset('sh.png') }}" alt=""><a href="/admin_negotiate">Negosiasi</a></li>
            <li><img src="{{ asset('undo.png') }}" alt=""><a href="/admin_tendercontrol">Kontrol Tender</a>
            </li>
            <li><img src="{{ asset('file.png') }}" alt=""><a href="/admin_questionaire">Questioner</a></li>
            <li><img src="{{ asset('bat.png') }}" alt=""><a href="/admin_maketender">Buat Akun Vendor</a>
            </li>
            ...
            <li><img src="{{ asset('alert.png') }}" alt=""><a href="/admin_complainlist">Daftar
                    Komplain</a></li>
        </ul>
    </div>
</header>
